package com.example.copytotext.user;
...
import com.example.copytotext.databinding.FragmentUpdateUserBinding;
...
public class UpdateUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.txtName.setText(GobalAccessData.userDetail.getName());
        binding.txtUserCity.setText(GobalAccessData.userDetail.getCity());
        binding.txtUserPhoneNo.setText(GobalAccessData.userDetail.getPhone());
        binding.txtUserDuration.setText(GobalAccessData.userDetail.getDuration());
        binding.txtUserPayFee.setText(GobalAccessData.userDetail.getFee());

//        selectedDateStart =GobalAccessData.userDetail.getStartdate().split("T")[0];
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    if (!s.toString().isEmpty()) {
                        ...
                        selectedDateEnd = GobalAccessData.userDetail.getEnddate()
                        ;
//                       openDatePickerNextMont(monthOffset);
                    } else {
                        monthOffset = 1;
...
//                Toast.makeText(getActivity(), ""+duration, Toast.LENGTH_SHORT).show();
                ...
                if(selectedDateStart==null){
                    start=GobalAccessData.userDetail.getStartdate();
                }
                if(selectedDateEnd==null){
                    end=GobalAccessData.userDetail.getEnddate();
                }
                ...
                if(imgeArr!=null){
                    ...
                    api.UserAddUpdate("updateDataOrImage",GobalAccessData.userDetail.getId(),name,city,start,end,duration,fee,phone,requestBodyBinaryImage).enqueue(new Callback<String>() {
                        @Override
...
//                                Toast.makeText(getContext(), ""+response.body(), Toast.LENGTH_SHORT).show();
                    ...
                    api.UserAddUpdate("updateDataOrImage",GobalAccessData.userDetail.getId(),name,city,start,end,duration,fee,phone).enqueue(new Callback<String>() {
                        @Override
                        public void onResponse(Call<String> call, Response<String> response) {
                            if(response.isSuccessful()){
                                loadingDialog.dismiss(); //add this line here
...
//        Toast.makeText(getContext(), ""+GobalAccessData.userDetail.getStartdate(), Toast.LENGTH_SHORT).show();
        int year = Integer.parseInt(GobalAccessData.userDetail.getEnddate().split("-")[0]);
        int month = Integer.parseInt(GobalAccessData.userDetail.getEnddate().split("-")[1]);
        int day = Integer.parseInt(GobalAccessData.userDetail.getEnddate().split("-")[2]);

//        binding.txtUserDuration.setText(""+GobalAccessData.userDetail.getEnddate().split("T")[0]);
...
//        binding.txtUserDuration.setText(""+GobalAccessData.userDetail.getStartdate().split("T")[0]);
        int year = Integer.parseInt(GobalAccessData.userDetail.getStartdate().split("-")[0]);
        int month = Integer.parseInt(GobalAccessData.userDetail.getStartdate().split("-")[1]);
        int day = Integer.parseInt(GobalAccessData.userDetail.getStartdate().split("-")[2].split("T")[0]);
